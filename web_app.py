...
def fetch_market_valuation(card_name, grade_filter=""):
    """
    FORCED SOLD LOGIC: Uses last_sold_date filter to ignore active listings.
    """
    ...
    try:
        ...
        # Calculate 90-day window to force 'Sold' results
        ...
        # THE SECRET SAUCE: filter=last_sold_date:[RANGE]
        # This parameter is the ONLY way to guarantee you aren't seeing active listings.
...
# ... (Original detect_cards and auto_label_crops remain unchanged) ...
